...
let myLibrary = [];
const book1 = new Book("Lord of the onion rings", "Burger King", 49, "no");
let book2 = new Book("How to kill a mean pigeon", "Terrance Hill", 143, "no");
let book3 = new Book(
...
let book4 = new Book("My life as an astral trash lover", "Stella", 203, "no");
